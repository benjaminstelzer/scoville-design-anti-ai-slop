# Fable independent professional reference Plan bundle

Date: 2026-09-02  
Status: frozen W-013 Fable input; excludes every SOL response and reconciliation record  
Files: 65  
Aggregate SHA-256: `66ED3E2BC8676AD53D6F121C787B8C77DA9ED58399CE44C4730F942196368408`

Sort absolute Windows paths, normalize manifest separators to `/`, record
`relative/path|UPPERCASE_SHA256`, join with LF and no terminal LF, and hash the
UTF-8 sequence. The Fable prompt must not direct the reviewer to other files in
`docs/reviews/`; they are deliberately excluded to preserve adviser
independence. Runtime Design and UI files remain unchanged.
...
scoville-design-anti-ai-slop/docs/evaluation/leaf-contract-matrix.yaml|465B593B934AE5B530DD2C1D471EC7620B81FDB2BD99357E62110C5FFC85B992
scoville-design-anti-ai-slop/docs/evaluation/open-successor-call-plan.md|DE9067FF9D5EE7F367F19F5FC0EEABDFF2B2A3A51F0AF8468384079579E8E46B
scoville-design-anti-ai-slop/docs/evaluation/validate_open_call_matrix.py|F0C2BFFCDE197B625415DD5B6C7B37CEA12AB127DB172DC684470ABC90339B51
...
Independently review completeness, routing, ownership, source and rule
epistemics, implementation sequence, the 23-leaf/six-dimension matrix,
canonical modes, early-fail budget, SkillOpt gate, forgotten generalist
capabilities, typography, composition, spacing, style, responsive/fixed media,
and claim ceilings. Return `READY` only with no Blocker or High finding.
