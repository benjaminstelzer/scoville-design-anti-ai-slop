...
**Decision served:** identify the three most-starred current, qualifying exact-domain Skills with E1+ evidence for editable artifact generation, rendering, preflight, export, and handoff; compare them with [the current executable](../../../../scoville-design-anti-ai-slop/references/media-production-and-handoff.md) and [the expert-depth audit](../reference-audits/media-production-and-handoff.md).  
