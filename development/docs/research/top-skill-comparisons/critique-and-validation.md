...
**Decision served:** identify the three most-starred current, qualifying exact-domain Skills with E1+ evidence for visual/design critique, audit, repair, and validation; compare them with [the current executable](../../../../scoville-design-anti-ai-slop/references/critique-and-validation.md) and [the expert-depth audit](../reference-audits/critique-and-validation.md).  
