#!/usr/bin/env python3
"""Build final adjudicated RC4 routing regression without rewriting v4."""
...
SOURCE = ROOT / "benchmark-v4"
TARGET = ROOT / "benchmark-v5"
...
CORRECTED = {
    ...
    "route-rc2-val-editorial-template": ["brand-and-visual-systems"],
}
...
def main() -> int:
    ...
    print("wrote final adjudicated design routing benchmark-v5")
    return 0
