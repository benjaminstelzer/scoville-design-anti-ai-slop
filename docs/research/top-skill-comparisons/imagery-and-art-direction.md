...
**Decision served:** identify the three most-starred current, qualifying exact-domain Skills whose repositories contain at least E1 evidence; compare their demonstrated mechanisms with [the current executable](../../../references/imagery-and-art-direction.md) and [the expert-depth audit](../reference-audits/imagery-and-art-direction.md).  
