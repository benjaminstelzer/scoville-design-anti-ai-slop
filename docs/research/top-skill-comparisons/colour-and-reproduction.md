...
**Decision served:** identify the three most-starred current, qualifying exact-domain Skills whose repositories contain at least E1 evidence; compare their demonstrated mechanisms with [the current executable](../../../references/colour-and-reproduction.md) and [the expert-depth audit](../reference-audits/colour-and-reproduction.md).  
